...
<jsp:useBean id="CreaNecessitaBoundary" scope="application" class="bean2.CreaNecessitaBoundary"/>
...
Class.forName("com.mysql.jdbc.Driver");
	if(request.getParameter("CREA ANNUNCIO")!=null){
		if (CreaNecessitaBoundary.creaAnnuncioPressed(request.getParameter("tipologia"),request.getParameter("urgenza"), request.getParameter("richiesta")) == 0){
%>
...
<body>
	<form action = "creaNecess.jsp" name = "reg" method = "POST">
